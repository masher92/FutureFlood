...
for catchment_num in catchments_to_run_sorted:
    ...
    emit(f"Mask created in {time.time()-t0:.1f}s")
    ...
    for ens_num in ENSEMBLE_MEMBERS:
        ...
        for year, events_in_year in rainfall_events.groupby('start_year'):
            ...
            for row in events_in_year.itertuples():
                ...
                this_event_results['start_year']  = event_details['year']
...
#                 this_event_results['rainfall_peak_360'] = this_event_results['rainfall_peak_day'].apply(
